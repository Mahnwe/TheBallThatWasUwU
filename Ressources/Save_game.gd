...
func saveData():
	if is_level_1:
		var file = FileAccess.open("res://Ressources/timer_rank_data_level1.json", FileAccess.WRITE)
		file.store_line(JSON.stringify(file_data))
	if is_level_2:
		var file = FileAccess.open("res://Ressources/timer_rank_data_level2.json", FileAccess.WRITE)
		file.store_line(JSON.stringify(file_data))
	if is_level_3:
		var file = FileAccess.open("res://Ressources/timer_rank_data_level3.json", FileAccess.WRITE)
		file.store_line(JSON.stringify(file_data))

func load():
	if is_level_1:
		var check_if_file_empty = FileAccess.get_file_as_string("res://Ressources/timer_rank_data_level1.json")
		if check_if_file_empty.is_empty():
			saveData()
			return
		else:
			var file = FileAccess.open("res://Ressources/timer_rank_data_level1.json", FileAccess.READ)
			var data = JSON.parse_string(file.get_as_text())
			file_data = data
	elif is_level_2:
		var check_if_file_empty = FileAccess.get_file_as_string("res://Ressources/timer_rank_data_level2.json")
		if check_if_file_empty.is_empty():
			saveData()
			return
		else:
			var file = FileAccess.open("res://Ressources/timer_rank_data_level2.json", FileAccess.READ)
			var data = JSON.parse_string(file.get_as_text())
			file_data = data
	elif is_level_3:
		var check_if_file_empty = FileAccess.get_file_as_string("res://Ressources/timer_rank_data_level3.json")
		if check_if_file_empty.is_empty():
			saveData()
			return
		else:
			var file = FileAccess.open("res://Ressources/timer_rank_data_level3.json", FileAccess.READ)
			var data = JSON.parse_string(file.get_as_text())
			file_data = data
