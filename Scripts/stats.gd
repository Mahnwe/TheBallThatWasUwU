...
func set_up_stats_with_file():
	$HSplitContainer/VBoxContainer/HSplitContainer/JumpNumber.text = str($SaveManager.get_stats_value("Stats", "jump_number"))
	$HSplitContainer/VBoxContainer/HSplitContainer2/DashNumber.text = str($SaveManager.get_stats_value("Stats", "dash_number"))
	$HSplitContainer/VBoxContainer/HSplitContainer9/DeathNumber.text = str($SaveManager.get_stats_value("Stats", "death_number"))
	$HSplitContainer/VBoxContainer/HSplitContainer3/DeathSpikeNumber.text = str($SaveManager.get_stats_value("Stats", "spike_death_number"))
	$HSplitContainer/VBoxContainer/HSplitContainer4/DeathCannonNumber.text = str($SaveManager.get_stats_value("Stats", "cannon_death_number"))
	$HSplitContainer/VBoxContainer/HSplitContainer5/DeathCoralNumber.text = str($SaveManager.get_stats_value("Stats", "coral_death_number"))
	$HSplitContainer/VBoxContainer/HSplitContainer6/DeathAcidNumber.text = str($SaveManager.get_stats_value("Stats", "acid_death_number"))
	$HSplitContainer/VBoxContainer/HSplitContainer7/DeathLaserNumber.text = str($SaveManager.get_stats_value("Stats", "laser_death_number"))
	$VBoxContainer2/HSplitContainer8/ChestNumber.text = str($SaveManager.get_properties_value("Chests", "chestNumber"))
	$HSplitContainer/VBoxContainer3/HSplitContainer/LevelNumber.text = str($SaveManager.get_stats_value("Stats", "finished_level_number"))
	$HSplitContainer/VBoxContainer3/HSplitContainer2/Level1Number.text = str($SaveManager.get_stats_value("Stats", "level_one_finished_number"))
	$HSplitContainer/VBoxContainer3/HSplitContainer3/Level2Number.text = str($SaveManager.get_stats_value("Stats", "level_two_finished_number"))
	$HSplitContainer/VBoxContainer3/HSplitContainer4/Level3Number.text = str($SaveManager.get_stats_value("Stats", "level_three_finished_number"))
	$HSplitContainer/VBoxContainer3/HSplitContainer5/Level4Number.text = str($SaveManager.get_stats_value("Stats", "level_four_finished_number"))
	$HSplitContainer/VBoxContainer3/HSplitContainer6/Level5Number.text = str($SaveManager.get_stats_value("Stats", "level_five_finished_number"))
	$HSplitContainer/VBoxContainer3/HSplitContainer7/Level6Number.text = str($SaveManager.get_stats_value("Stats", "level_six_finished_number"))
	$HSplitContainer/VBoxContainer3/HSplitContainer8/Level7Number.text = str($SaveManager.get_stats_value("Stats", "level_seven_finished_number"))
	$VBoxContainer2/HSplitContainer/MedalNumber.text = str($SaveManager.get_stats_value("Stats", "medal_number"))
	$VBoxContainer2/HSplitContainer2/BronzeMedalNumber.text = str($SaveManager.get_stats_value("Stats", "bronze_medal_number"))
	$VBoxContainer2/HSplitContainer3/SilverMedalNumber.text = str($SaveManager.get_stats_value("Stats", "silver_medal_number"))
	$VBoxContainer2/HSplitContainer4/GoldMedalNumber.text = str($SaveManager.get_stats_value("Stats", "gold_medal_number"))
	$VBoxContainer2/HSplitContainer5/DevMedalNumber.text = str($SaveManager.get_stats_value("Stats", "dev_medal_number"))
	$VBoxContainer2/HSplitContainer6/TimePlayedNumber.text = $TimeControl._format_seconds($SaveManager.get_stats_value("Stats", "time_played"))
...
func title_animation():
	if $TitleLabel.scale <= Vector2(0.642,0.647):
		...
		move_tween.tween_property($TitleLabel, "position", Vector2(805.0,77.0), 1.0)
	...
	if $TitleLabel.scale == Vector2(0.672,0.677):
		...
		move_tween.tween_property($TitleLabel, "position", Vector2(812.0,80.0), 1.0)
